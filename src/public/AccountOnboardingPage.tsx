...
export default function AccountOnboardingPage() {
  ...
  return <main className="account-access-page">
    ...
    <div className="account-access-shell compact">
      <section className="account-access-intro"><p>ÚLTIMA ETAPA</p><h1>COMPLETE SEU<br/><em>PERFIL</em></h1><span>Esses dados alimentam as regras de idade, categorias e segurança do ecossistema. A consulta de CPF na Receita está temporariamente suspensa; o CPF continua sendo armazenado e verificado apenas quanto à unicidade da conta.</span><div><ShieldCheck/><b>Onboarding server-authoritative</b><small>Plano, score, permissões e flags privilegiadas continuam definidos pelo backend.</small></div></section>
