...
export default function AccountSignupPage() {
  ...
  return <main className="account-access-page">
    ...
    <div className="account-access-shell">
      <section className="account-access-intro"><p>CONTA ÚNICA INVICTUS</p><h1>COMECE SUA<br/><em>JORNADA</em></h1><span>Crie a identidade de acesso uma vez e use a mesma conta no site e no aplicativo.</span><div><ShieldCheck/><b>Mesmo Firebase Auth</b><small>Nenhuma conta paralela é criada no site.</small></div></section>
