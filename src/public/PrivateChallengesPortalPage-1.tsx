    ...
    <div className="friends-live-shell">
      <section className="friends-live-gate">
        ...
        <div className="friends-live-howto">
          ...
          <article><BarChart3/><div><b>Acompanhe o IGA</b><span>A classificação combina consistência semanal, duração e intensidade das suas atividades, e atualiza automaticamente até o fim da janela do desafio.</span></div></article>
        </div>
      </section>
